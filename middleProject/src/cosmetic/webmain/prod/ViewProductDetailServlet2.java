...
@WebServlet("/view/detail2")
public class ViewProductDetailServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/view/detail/detail2.jsp").forward(request, response);;
