...
@WebServlet("/view/detail5")
public class ViewProductDetailServlet5 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("prodId", request.getParameter("prod_id"));
		
		request.getRequestDispatcher("/WEB-INF/view/detail/detail5.jsp").forward(request, response);;
