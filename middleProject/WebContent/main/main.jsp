...
<html lang="en">
    <head>
        ...
        <script src="https://kit.fontawesome.com/20c5a1496b.js" crossorigin="anonymous" charset="utf-8"></script>
        <link
        ...
        <link
            ...
            rel="stylesheet">
            <script defer src="<%=request.getContextPath()%>/js/main_dark.js" charset="utf-8"></script>
        ...
        <div
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../imgs/main1.jpg" class="d-block w-100" alt="main1" >
                ...
                <div class="carousel-item">
                    <img src="../imgs/main2.jpg" class="d-block w-100" alt="main2" >
                    <div class='slide__con'>
                        <div class="main_left">
        ...
        <div class="section_container" id="innistar" >
            ...
            <div class="insta__in">
                <a href=href=# class="project" target="blank">
                    <img src="../imgs/star1.jpg" alt="insta" class="insta_img">
                ...
                <a href=href=# class="project" target="blank">
                    <img src="../imgs/star2.jpg" alt="insta" class="insta_img">
                    <div class="insta_description">
                        <h3>Joy@gmail.com</h3>
                ...
                <a href=href=# class="project" target="blank">
                    <img src="../imgs/star3.jpg" alt="insta" class="insta_img">
                    <div class="insta_description">
                ...
                <a href=# class="project" target="blank">
                    <img src="../imgs/star4.jpg" alt="insta" class="insta_img">
                    <div class="insta_description">
                ...
                <a href=# class="project" target="blank">
                    <img src="../imgs/star5.jpg" alt="insta" class="insta_img">
                    <div class="insta_description">
                ...
                <a href=# class="project" target="blank">
                    <img src="../imgs/star6.jpg" alt="insta" class="insta_img" >
                    <div class="insta_description">
                ...
                <a href=# class="project" target="blank">
                    <img src="../imgs/star7.jpg" alt="insta" class="insta_img">
                    <div class="insta_description">
                ...
                <a href=# class="project" target="blank">
                    <img src="../imgs/star8.jpg" alt="insta" class="insta_img">
                    <div class="insta_description">
            ...
            <a href="../member/member.html">
                <button class="innistar__view">
                    <a href="../member/member.html"><div class="view" >View more 
    ...
    <div class="section_container">
        <div class="common__head">
            ...
            <div class="product__in-box1">
                <img src="../imgs/pro1.jpg" alt="" class="product__img">
                <p class="prodcuct__des">Clay Mask</p>
                <img src="../imgs/pro2.jpg" class="product__img">
                <p class="prodcuct__des">serum</p>
            </div>
            <div class="product__in-box2">
                <img src="../imgs/pro3.jpg" class="product__img big">
...
<section id="iphone">
            ...
            <div class="screen">
                ...
                <div class="content-wrapper">
                    <div class="content">
                        <ol class="messages">
                            <li>
                                <p>ID: a001 </br> 몇번째 구매인지 몰라요 넘좋음!ㅎㅎㅎ </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: a002 </br> 이거 쓰고 여드름 다 들어갔어요ㅠ 다들쓰세요 </br>Date: 2021.5.9</p>
                            </li>
                            <li>
                                <p>ID: a0164 </br> 세일기간에 저렴하게 구매했어요 잘맞았으면 좋겠네요. </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: dfdf587 </br> 7번째 구매입니다. 항상 칼배송이네요! 여기 제품은 말모..bbbb </br>Date: 2021.10.5</p>
                            </li>
                        
                            <li>
                                <p>ID: sd5f487 </br> 몇번째 구매인지 몰라요 넘좋음!ㅎㅎㅎ </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: df5445 </br> 이거 쓰고 여드름 다 들어갔어요ㅠ 다들쓰세요 </br>Date: 2021.5.9</p>
                            </li>
                            <li>
                                <p>ID: q54d64 </br> 세일기간에 저렴하게 구매했어요 잘맞았으면 좋겠네요. </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: a0207 </br> 7번째 구매입니다. 항상 칼배송이네요! 여기 제품은 말모..bbbb </br>Date: 2021.10.5</p>
                            </li>
                            <li>
                                <p>ID: n4887 </br> 몇번째 구매인지 몰라요 넘좋음!ㅎㅎㅎ </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: sky45 </br> 이거 쓰고 여드름 다 들어갔어요ㅠ 다들쓰세요 </br>Date: 2021.5.9</p>
                            </li>
                            <li>
                                <p>ID: ddit64 </br> 세일기간에 저렴하게 구매했어요 잘맞았으면 좋겠네요. </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: qwekim87 </br> 7번째 구매입니다. 항상 칼배송이네요! 여기 제품은 말모..bbbb </br>Date: 2021.10.5</p>
                            </li>
                            <li>
                                <p>ID: fyck87 </br> 몇번째 구매인지 몰라요 넘좋음!ㅎㅎㅎ </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: king45 </br> 이거 쓰고 여드름 다 들어갔어요ㅠ 다들쓰세요 </br>Date: 2021.5.9</p>
                            </li>
                            <li>
                                <p>ID: godd64 </br> 세일기간에 저렴하게 구매했어요 잘맞았으면 좋겠네요. </br>Date: 2021.3.2</p>
                            </li>
                            <li>
                                <p>ID: land87 </br> 7번째 구매입니다. 항상 칼배송이네요! 여기 제품은 말모..bbbb </br>Date: 2021.10.5</p>
                            </li>
    ...
    <button class="innistar__view">
        <a href="../review/review1.html"><div class="view" >View more 
            <i class="fas fa-arrow-down"></i></a>
        </div>
    </button>
    </div>
...
<section class="news" id="news">
    ...
    <section class="store" id="store">
        <img src="../imgs/store.jpg" alt="" class="store__img">
        ...
        <div class="store__box">
            ...
            <p class="store__box-btn">
                <a href="../notice/notice.html">View more
                    <i class="fas fa-arrow-right"></i>
                </a>
            </p>
        </div>
