...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath() %>/css/review2.css">
...
$(document).ready(function(){
	...
	$('.prev').on('click', function(){
		 var prod_id = $('#prod_id').text();
			...
			location.href="<%=request.getContextPath()%>/review/reviewList2?page="+currentPage+"&prod_id="+prod_id;
	})
